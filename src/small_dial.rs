...
pub const NEEDLE_LENGTH_FACTOR: f64 = 0.9; // Factor to scale the needle length relative to the dial radius
...
pub const READOUT_BIG_FONT_SIZE: f32 = 30.0; // Font size for the integer part of the readout
pub const READOUT_SMALL_FONT_SIZE: f32 = 20.0; // Font size for the fractional part of the readout

pub const READOUT_BOX_PADDING: i32 = 20; // Padding around the readout box
pub const READOUT_BOX_THICKNESS: f32 = 2.0; // Thickness of the readout box lines
...
pub const WINDOW_WIDTH: usize = 150; // Width of the application window
pub const WINDOW_HEIGHT: usize = 150; // Height of the application window
